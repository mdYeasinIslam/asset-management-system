        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">Our Mission & Vision</h2>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 leading-relaxed">
                      To empower organizations worldwide with intelligent asset management solutions that drive
                      operational efficiency, reduce costs, and enable data-driven decision-making.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 leading-relaxed">
                      To become the global leader in asset management innovation, connecting millions of users and
                      managing billions of assets with unprecedented efficiency and transparency.
                    </p>
                  </div>
                </motion.div>
              </div>
            ...
            >
              ...
              <div className="relative bg-slate-800/50 backdrop-blur-sm rounded-3xl p-8 border border-slate-700">
                <div className="aspect-video bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl flex items-center justify-center border border-slate-600">
                  ...
                  >
                    <BarChart3 className="w-24 h-24 text-blue-400/30" />
                  </motion.div>
                </div>
              </div>
            </motion.div>
