...
const testimonials = [
  {
    ...
    rating: 5,
    image: "/images/home/reviewImg.png",
  },
  {
    name: "Jason Loped",
...
const Testimonials = () => {
  ...
  return (
    <section className="bg-white dark:bg-gradient-to-b dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-16 px-5 xl:px-0">
