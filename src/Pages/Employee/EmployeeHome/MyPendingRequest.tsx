...
export const MyPendingRequest = ({ requestedAssets }: { requestedAssets: AssetRequestType[] }) => {
  ...
  return (
    <Card className="bg-gray-100  p-1 text-center md:p-2 rounded-xl duration-500 transition-transform hover:scale-95  shadow-md hover:shadow-lg  ">
        <CardHeader>
        ...
        <CardContent>
             <p className="text-4xl font-bold text-blue-600 text-center">
              ...
              <p className="text-gray-600 text-center">You currently have {pendingRequest?.length} pending asset requests.</p>
        </CardContent>
    </Card>
  )
}
