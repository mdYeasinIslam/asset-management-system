...
export const PendingSection = ({pendingRequest}:{pendingRequest:AssetRequestType[]}) => {
    ...
    <p className="text-gray-800 w-1/2 text-center">Find assets as your choice and neccesity. And use them carefully ,may be you need to return it to the company.</p>
  </div>
  return (
    <div className="space-y-5">
      ...
      <div
        className={`grid grid-cols-1 md:grid-cols-2  gap-2 ${
          pendingRequest.length > 2 ? "lg:grid-cols-3 " : "lg:grid-cols-3 xl:grid-cols-4"
        }`}
      >
